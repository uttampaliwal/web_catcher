...
Welcome to **Web Catcher**! This tool is designed to help you "suck" data from the internet (Webpages, Wikipedia, PDFs) and turn it into structured, machine-readable JSON. Whether you're a seasoned ML engineer or just getting started, this guide will walk you through every command you need.
